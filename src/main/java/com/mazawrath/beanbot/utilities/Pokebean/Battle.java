...
import com.mazawrath.beanbot.utilities.Pokebean.Monster.*;
import com.mazawrath.beanbot.utilities.Pokebean.interactive.Player;

public class Battle {
    private Player p;
    private Pokebean opponent, player;
     ...
     */
    public Battle(Player p, Pokebean opponent) {
        this.p = p;
    ...
    public static boolean applyStatus(final Move m, final Pokebean p) {
    ...
    private String useMoveInOrder(Pokebean first, Move firstMove, Pokebean second, Move secondMove) {
    ...
    private int calcExp(Pokebean victor, Pokebean loser) {
    ...
    private short calculateDamage(Pokebean attacking, Move used, Pokebean defending) {
    ...
    private float typeEffectiveness(Pokebean defending, Move used) {
     ...
     * @return
     */
    private float modifiers(Pokebean attacking, Move used, Pokebean defending) {
        //http://bulbapedia.bulbagarden.net/wiki/Damage_modification#Damage_formula
        float stab = 1;
